...
//    	srp.test();
    ...
    public static void test(String user, String pass)
    {
        ...
        SRP6 srpServer = new SRP6(user, pass, modulus, 0x02, 256, 128);
        SRP6 srpClient = new SRP6(user, pass, modulus, 0x02, srpServer.getSalt());
    ...
    public static byte[] bigToByteArray(BigInteger bigI)
    {
        if (bigI == null)
            return new byte[] { 0 };
